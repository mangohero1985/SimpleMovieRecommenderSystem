...
public class MyUserBasedRecommender {
	public List<RecommendedItem> userBasedRecommender(long userID,int size) {
		...
		try {
			//DataModel model = MyDataModel.myDataModel();//构造数据模型从数据库
			DataModel model = new FileDataModel(new File("/Users/mangohero1985/Documents/svnCheckout/MahoutTaste/ml-1m/ratingsNoTime.txt"));
