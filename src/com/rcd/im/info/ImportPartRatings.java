...
public class ImportPartRatings {

	public final static String TABLE_NAME = "movie_preferences_part";
	...
	public static void main(String[] args) {
		try {
			LineNumberReader lineReader = new LineNumberReader(new FileReader(
					"/Users/mangohero1985/Documents/svnCheckout/MahoutTaste/ml-1m/ratingcopy.dat"));
			String line = "";
